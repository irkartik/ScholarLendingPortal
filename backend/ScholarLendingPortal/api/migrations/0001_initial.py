    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('sports', 'Sports Equipment'), ('lab', 'Lab Equipment'), ('camera', 'Camera & Photography'), ('musical', 'Musical Instruments'), ('project', 'Project Materials'), ('other', 'Other')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('equipment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='borrow_requests', to='api.equipment')),
            ],
            options={
